...
<div id="content">
  ...
  <div class="page" id="blog-archives" role="main">
    <h3 class="pagetitle"><?php printf( __( 'Informaci&oacute;n mas &uacute;til para una estad&iacute;a de %1$s.', 'buddypress' ), wp_title( false, false ) ); ?></h3>
    <?php if ( have_posts() ) : ?>
    ...
    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      ...
      <div class="post-content">
        ...
        <div class="entry">
          <?php the_content( __( 'Leer m&aacute;s &rarr;', 'buddypress' ) ); ?>
